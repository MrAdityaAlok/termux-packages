...
lib/ghc-$TERMUX_PKG_VERSION/*-linux-ghc-$TERMUX_PKG_VERSION-inplace/ghc-$TERMUX_PKG_VERSION
lib/ghc-$TERMUX_PKG_VERSION/*-linux-ghc-$TERMUX_PKG_VERSION-inplace/libHSghc-$TERMUX_PKG_VERSION-inplace-ghc$TERMUX_PKG_VERSION.so
